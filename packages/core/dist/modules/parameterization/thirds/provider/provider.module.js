...
const provider_resolver_1 = require("./provider.resolver");
...
exports.ProviderModule = ProviderModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([provider_entity_1.default])],
        providers: [provider_resolver_1.ProviderResolver, provider_service_1.ProviderService]
    })
], ProviderModule);
