...
function  FormCredit({dataCredit}:{dataCredit:RefinanceCredit}){
  ...
  useEffect(() =>{
   ...
   const handleGenerateTable= () => {
      if(option===0){ 
	 console.log(credit.discountDate)
 ...
 useEffect(() => {
   ...
   return (
	 ...
	 <div className="flex justify-between ">
	    <label className="font-bold px-4 item-center  bg-white pt-2">Refinaciar credito</label>
	    ...
	    <div className=" flex-grow flex flex-row">
		  ...
		  />
	       ...
	       <div className="pt-2 flex justify-end mr-4 ">
			...
			<button className="flex flex-row rounded-sm bg-[#F2F5FA] p-2 " onClick={handleGenerateTable}>
