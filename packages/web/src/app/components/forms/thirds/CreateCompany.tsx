...
function  CreateThirdCompany({setCreate}:{setCreate:any}){
      ...
      const [createCompany, { data: companyData, loading: loadingCompany, error: errorCompany }] = useMutation(CREATE_COMPANY);
      const {handleChangeCompanyNubmer,handleCompanyInformation,companyInformation,handleChangeCompanyInformation }=useCompany()
 ...
 useEffect(() => {
   ...
   return (
	   <Modal 
	    ...
	    <FormCompany handleChangeCompanyInformation={handleChangeCompanyInformation} 
