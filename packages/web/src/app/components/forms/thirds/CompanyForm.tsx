...
import { IdentificationForm, RegimeForm, TypePersonForm } from "@/lib/utils/thirds/selectForm";
import React from 'react';

export function FormCompany({ companyInformation, handleChangeCompanyInformation,handleCompanyInformation,handleChangeCompanyNumber }:
    { companyInformation: any, handleChangeCompanyInformation: any ,handleChangeCompanyNumber:any,handleCompanyInformation:any}) {

    return (
        <div className="flex flex-col m-3">
	 

	    <label className="text-center text-white  bg-[#3C7ac2] text-input font-bold mb-2">Datos empresa</label>
            <InputField
                        name="socialReason"
                        label="Razón Social"
		  ...
		  <label className="text-center text-white  bg-[#3C7ac2] text-input font-bold mb-2">Datos representante legal</label>
		   <SelectField
