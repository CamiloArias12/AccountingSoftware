...
function TableAmortization({setSelected,data,setData}:{data:AmortizationTable[],setData:any,setSelected:any}){
   

   const [generateAmortizationChange, { data:dataAmortizationChange, loading: loadingAmortizationChange, error: errorAmortizationChange}] = useMutation(GENERATE_TABLE_AMORTIZATION_CHANGE);
