    ...
    <>
      {toggleBar && (
        <div className="fixed top-0 left-0 z-10">
          <div className={`absolute  w-12 h-12 top-[22px]  left-1 z-20`}>
            <img
              height={50}
              width={25}
              src="/menu.svg"
      ...
      <ClickOutside
        ...
        className={`fixed z-10  flex flex-col shadow-2xl h-screen flex-grow  bg-white  ${
          !toggleBar ? 'w-[250px]' : 'hidden'
        }`}
      >
        <div></div>
