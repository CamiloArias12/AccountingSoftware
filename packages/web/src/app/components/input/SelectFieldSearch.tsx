...
function SelectFieldTest ({options}:{options:any} ) {
    ...
    return (
        < div className="flex flex-col relative">
            <label className="text-xs pb-2">Pais</label>
	    <button className="bg-white relative w-full flex border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
	    ...
	    <div className="flex flex-grow">
	       <ul className=" flex absolute w-full z-10 mt-1 flex-grow bg-white shadow-lg max-h-100 rounded-md text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
		  ...
		  {toggle &&
		     options.map((option:any) =>(
			   <li className=" flex-grow text-gray-900 cursor-default select-none relative py-3  flex items-center hover:bg-gray-50 transition" 
