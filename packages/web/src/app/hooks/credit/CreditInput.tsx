...
const [credit,setCredit]=useState({
    ...
    const handleCredit = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
   ...
   const handleCreditNumber = (name:string,value:any) => {
	 ...
	 if(name==="newBalance" || name ==="previewBalance"){
	    setCredit({ ...credit, creditValue: Number(credit.previewBalance)+Number(credit.newBalance) });
	 }
